...
- **Branch:** `main`
- **Exported:** 2026-08-09T22:28:07.729125Z
- **Quality Gate:** OK
- **Unresolved issues:** 406
...
| Value | Count |
|---|---:|
| typescript:S6759 — React props should be read-only | 105 |
| typescript:S3358 — Ternary operators should not be nested | 50 |
| typescript:S3776 — Cognitive Complexity of functions should not be too high | 34 |
| typescript:S6582 — Optional chaining should be preferred | 29 |
| typescript:S6571 — Type constituents of unions and intersections should not be redundant | 24 |
| typescript:S7772 — Node.js built-in modules should be imported using the "node:" protocol | 16 |
| typescript:S6819 — Prefer tag over ARIA role | 10 |
| typescript:S7773 — Number static methods and properties should be preferred over global equivalents | 7 |
| typescript:S7744 — Unnecessary fallback objects should not be used when spreading in object literals | 7 |
...
| typescript:S7741 — "typeof" should not be used to check for "undefined" | 5 |
| typescript:S7781 — Strings should use "replaceAll()" instead of "replace()" with global regex | 5 |
...
| typescript:S6644 — Ternary operator should not be used instead of simpler alternatives | 5 |
| typescript:S6653 — Use Object.hasOwn static method instead of hasOwnProperty | 4 |
...
| typescript:S6606 — Nullish coalescing should be preferred | 4 |
| typescript:S6767 — Unused React typed props should be removed | 4 |
...
| typescript:S7769 — Modern Math APIs should be used instead of legacy mathematical expressions | 3 |
| typescript:S6594 — "RegExp.exec()" should be preferred over "String.match()" | 3 |
| typescript:S1874 — Deprecated APIs should not be used | 3 |
...
| Value | Count |
|---|---:|
| app/home/player/AudioEngine.tsx | 19 |
...
| app/home/player/playbackAccessClient.ts | 4 |
...
| app/home/modules/badges/BadgeUnlockVisual.tsx | 4 |
