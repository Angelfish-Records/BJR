...
function IntentSheet(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ padding: "8px 10px", fontSize: 12, opacity: 0.85 }}>
          Share
        </div>
...
export function useShareAction() {
  ...
  const [sheetTarget, setSheetTarget] = React.useState<ShareTarget | null>(
    null,
  );
