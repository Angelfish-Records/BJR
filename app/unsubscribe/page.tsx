    ...
    return (
      ...
      >
        <section style={cardStyle()}>
          ...
          >
            You won’t receive future marketing emails from Brendan John Roch.
            Transactional emails (e.g. gifts, receipts) may still be sent when
            required.
          </p>
        </section>
      </main>
      ...
      <section style={cardStyle()}>
        ...
        {!isValid ? (
          ...
          <>
            ...
            >
              You’re about to unsubscribe <b>{masked}</b> from future marketing
              emails.
            </p>
            ...
            >
              This action affects marketing only. Transactional emails (gifts,
              receipts, security messages) may still be sent when needed.
            </p>
          </>
        )}
      </section>
